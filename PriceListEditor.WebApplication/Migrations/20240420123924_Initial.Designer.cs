...
namespace PriceListEditor.WebApplication.Migrations
{
    ...
    [Migration("20240420123924_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.OptionalParameter", b =>
                {
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.PriceList", b =>
                {
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.PriceListOptionalParameter", b =>
                {
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.PriceListProduct", b =>
                {
                    b.Property<long?>("PriceListLineID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.Product", b =>
                {
                    b.Property<long?>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.PriceListOptionalParameter", b =>
                {
                    b.HasOne("PriceListEditor.WebApplication.Models.OptionalParameter", "OptionalParameter")
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.PriceListProduct", b =>
                {
                    b.HasOne("PriceListEditor.WebApplication.Models.PriceListOptionalParameter", "PriceListOptionalParameters")
            ...
            modelBuilder.Entity("PriceListEditor.WebApplication.Models.Product", b =>
                {
                    b.HasOne("PriceListEditor.WebApplication.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("PriceListPriceListProduct", b =>
                {
                    b.HasOne("PriceListEditor.WebApplication.Models.PriceListProduct", null)
                        .WithMany()
                        .HasForeignKey("PriceListProductsPriceListLineID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PriceListEditor.WebApplication.Models.PriceList", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PriceListProductProduct", b =>
                {
                    ...
                    b.HasOne("PriceListEditor.WebApplication.Models.Product", null)
                        .WithMany()
